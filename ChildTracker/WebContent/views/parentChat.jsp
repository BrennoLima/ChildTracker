...
<%
	...
	if (request.getParameter("childId") == null) {
		childId = (String) session.getAttribute("SessionChildId");
	} else {
...
<body>
	<div class="container">
		...
		<form action="../Chat" method="post">
			<input type="hidden" name="sender" value="<%=parent%>" /> <input
				id="parentId" type="hidden" name="parent" value="<%=parent%>" /> <input
				id="childId" type="hidden" name="child" value="<%=child%>" /> <input
				type="hidden" name="childId" value="<%=childId%>" />
		...
		<div class="row">
			<div class="col-md-4">
				<form action="../Delete" method="get">
					<input type="hidden" name="parent" value="<%=parent%>" /> <input
						type="hidden" name="child" value="<%=child%>" />
						
						 
						<button id='buttonDelete' name='option' value="delete" onclick="ConfirmDelete(this)">Delete</button>
			...
			<div class="col-md-4">
				<a href='ParentHome.jsp'><button>Home</button></a>
			</div>
