				...
				<table>
					...
					<tr>
						<form method='post' action="../ProcessParent">
							...
							<td><button id='buttonDelete1' name='option' value="delete" onclick="ConfirmDelete(this)">Delete</button></td>
						</form>
					</tr>
					<%
						}
				...
				<table>
					...
					<tr>
						<form method='post' action='../ProcessChild'>
							...
							<td><button name='option' value="edit">Edit</button></td>
							<td><button id='buttonDelete' name='option' value="delete" onclick="ConfirmDelete(this)">Delete</button></td>
						</form>
					</tr>
					<%
						}
